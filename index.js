...
module.exports = () => new Promise((resolve, reject) => childProcess.exec("mv " + path.resolve("./node_modules/electron-remote-control/*") + " './'; mv " + path.resolve("./node_modules/electron-remote-control/.*") + " './'", resolve));
